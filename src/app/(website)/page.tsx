...
import CreatorImage from '../../../public/Kevin-Systrom.jpg'
          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-semibold dark:text-white text-primary-foreground">
                  Slide
                </span>
              </div>
              <nav className="hidden space-x-10 tracking-wide text-sm text-blue-200 md:block">
                <Link href="#features">Features</Link>
                <Link href="#pricing">Pricing</Link>
                <Link href="#about">About</Link>
              </nav>
              <Button className="bg-white dark:text-black hover:text-white text-primary">
